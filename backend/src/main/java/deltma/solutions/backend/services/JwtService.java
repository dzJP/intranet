...
/** Service for handling operations related to JWTs **/
@Service
public class JwtService {
    ...
    // Generates a new JWT token for a UserDetails object.
    ...
    // Generates a new JWT token with specified extra claims and UserDetails.
